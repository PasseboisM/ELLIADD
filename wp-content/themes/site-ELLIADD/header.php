...
<header>
    <div>
        <a href="<?php echo home_url() ?>">
            <svg version="1.1" id="logo_ELLIADD" xmlns="http://www.w3.org/2000/svg"
...
<g id="logo">
    ...
    <g id="ELLIADD">
        <g>
            ...
            <path
                d="M172,89.4h-7l-3.7-22.9h-18.6l-3.5,22.9h-7l14-89.4h11.9L172,89.4z M143.8,59.6h16.4l-8-51.9H152L143.8,59.6z"
            />
        ...
        <nav class="menu_princ">
            <ul>
                <li>
                    <a href="<?php echo get_post_type_archive_link("pole") ?>"><span>Pôles</span></a>
                    <ul>
                        <?php
                ...
                <li>
                    <a href="<?php echo get_post_type_archive_link("membres") ?>"><span>Membres</span></a>
                    <ul>
                        <?php
                ...
                <li>
                    <a href="<?php echo get_post_type_archive_link('tribe_events'); ?>"><span>Calendrier scientifique</span></a>
                </li>

                <li>
                    <a href="<?php echo get_post_type_archive_link("programmes") ?>"><span>Programmes</span></a>
                </li>


                <li>
                    <a href="<?php echo get_post_type_archive_link("publications") ?>"><span>Publications</span></a>
                    <ul>
                        <?php
                        wp_list_categories(array(
                            "taxonomy" => "typePub",
                ...
                <li>
                    <span><i>Formations</i></span>
                    <ul>
                        <?php
                        wp_list_categories(array(
                            "taxonomy" => "typeFormation",
                            "title_li" => "",
                            "orderby" => "title",
                            "order" => "asc"
                        ));
        ...
        <nav class="menu_pole">
            ...
            while ($projets->have_posts()):
                ...
                <a class="<?php echo $class; ?>" title="<?php the_title(); ?>" href="<?php the_permalink(); ?>"></a>
                <?php $class = ''; endwhile; ?>
        </nav>
        <div>
        ...
        <div>
            <div>
                <a href="http://www.univ-fcomte.fr/"></a>
                <a href="http://www.ubfc.fr/"></a>
            </div>
            <span>
                <a href="<?php echo home_url(); ?>/wp-login.php">Connexion</a>
		</span>
        </div>
    </div>
</header>